...
To boost the performance of the method, they also do self-supervised learning and they need pseudo labels for this task. They obtain these pseudo labels from the models trained with different beta values. They pass target images through these models and take the mean prediction and behave these labels as ground truth. After getting pseudo labels, they add cross entropy loss for target images and train the network. 
