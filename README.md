...
At the end of the second round, they perform MBT again to get pseudo labels for the next round. In the last round, these labels are used in the networks and the last result is obtained with MBT. The following table includes the results for the overall training process.
<div align="center">
