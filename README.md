...
<div align="center">
<img width="553" alt="Ekran Resmi 2021-06-01 20 41 52" src="https://user-images.githubusercontent.com/56236171/124137745-456a4f80-da86-11eb-9e9e-a990be895ab0.png">
</div> 
In this equation p(ro) represents Charbonnier penalty function which penalizes high entropy predictions more than low entropy predictions for eta greater than 0.5. After scaling this loss function and summing it with cross entropy loss, they train the network from scratch for semantic segmentation.
